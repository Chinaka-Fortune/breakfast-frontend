    ...
    <div className="container py-y my-5">
      <div className="row align-items-center g-5">
        <div className="col-lg-6 text-center text-lg-start">
          <h1 className="display-3 text-white ourLandinAnimate2">Enjoy Our <br />Delicious Meal</h1>
          <p className='text-white Animated sliderInLeft mb-4 pb-2 scaleAnime'>Lorem ipsum dolor sit amet consectetur adipisicing. ipsum, dolor sit amet consectetur adipisicing elit. Dolore, pariatur harum </p>
